...
{
private:
	XMFLOAT3 m_Velocity;		// Ghostの速度ベクトル
	int m_InRangeFurnitureNum;	// 範囲内にある家具の番号（なければ-1）
	GHOST_STATE m_State;		// Ghostの状態
	float m_DetectionTimer;		// 検知状態のタイマー（1秒につきマイナス1するため）
